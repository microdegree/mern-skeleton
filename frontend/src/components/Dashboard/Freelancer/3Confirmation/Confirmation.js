        ...
        <div>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#68FFDC' }}><Card.Body>
                    ...
                    <Button variant="primary"><Link to='/freelancerDashboard/paymentsGateway' style={{ color: '#fff' }} onClick={confirmBookingAtServer}>Confirm Booking and go to Payments</Link></Button>
